...
function createBaseNode(): Node {
  return { id: Long.UZERO, metadata: Buffer.alloc(0), runId: undefined };
}
...
function createBaseDeleteRunRequest(): DeleteRunRequest {
  return { runId: "", userId: Long.UZERO };
}

export const DeleteRunRequest = {
  encode(message: DeleteRunRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.runId !== "") {
  ...
  create<I extends Exact<DeepPartial<DeleteRunRequest>, I>>(base?: I): DeleteRunRequest {
    return DeleteRunRequest.fromPartial(base ?? ({} as any));
  },
...
function createBaseDeleteRunResponse(): DeleteRunResponse {
  return { success: false, message: "", count: Long.UZERO };
}

export const DeleteRunResponse = {
  encode(message: DeleteRunResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.message !== "") {
  ...
  create<I extends Exact<DeepPartial<DeleteRunResponse>, I>>(base?: I): DeleteRunResponse {
    return DeleteRunResponse.fromPartial(base ?? ({} as any));
  },
...
export const RiceDBService = {
  ...
  deleteRun: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteRunRequest) => Buffer.from(DeleteRunRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteRunRequest.decode(value),
    responseSerialize: (value: DeleteRunResponse) => Buffer.from(DeleteRunResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DeleteRunResponse.decode(value),
  },
...
export interface RiceDBClient extends Client {
  ...
  deleteRun(
    ...
    callback: (error: ServiceError | null, response: DeleteRunResponse) => void,
  ): ClientUnaryCall;
  deleteRun(
    request: DeleteRunRequest,
    metadata: Metadata,
